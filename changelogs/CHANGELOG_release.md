# [5.4.0-s3](https://github.com/parse-community/parse-server/compare/5.4.0...5.4.0-s3) (2022-12-11)

### Improvements

* Addition of @parse/s3-files-adapter dependency to enable usage of S3 file storage and directAccess.
...
*SECURITY RELEASE*: see [advisory](https://github.com/parse-community/parse-server/security/advisories/GHSA-h4mf-75hf-67w4) for details
